...
Este proyecto muestra indicadores claros respecto de salarios (anual/por hora), cantidad de puestos de trabajo, países, empresas, formas de trabajo (presencial/remoto), necesidad de título, entre otros datos relevantes al momento de buscar un puesto de trabajo.  
Para ello se utiliza un *dataset real de publicaciones de ofertas de trabajo de puestos relacionados con datos del año 2024*; todos los datos se plasman en una interfaz simple e intuitiva.  
